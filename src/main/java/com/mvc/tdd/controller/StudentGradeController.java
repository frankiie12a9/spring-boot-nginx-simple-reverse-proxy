...
public class StudentGradeController {
    ...
    public String studentDetails(@PathVariable int id, Model m) {
        ...
        student.ifPresent(e -> {
          ...
          double mathGrades =  e.getStudentGrades().findGradePointAverage(e.getStudentGrades().getMathGradeResults());
          if (eligibleMathGradesCnt) 
            m.addAttribute("mathGradeAvg", mathGrades );
          else 
            m.addAttribute("mathGradeAvg", "N/A");
